...
class CharacterSTest {
    ...
    void fighterMayJoinToFactionsAndNewOneBelongsToNoFaction() {
        ...
        Faction faction1 = new Faction("Polar");
        Faction faction2 = new Faction("Alaska");

        faction1.addFighter(melee);
        faction1.addFighter(range);
        faction2.addFighter(melee);
